                ...
                {data.map(item => (
                    <div>
                        <a href={item.id} className="w-full lg:max-w-full ">
                            <div className="flex-none h-48 overflow-hidden text-center bg-cover rounded-t lg:h-auto lg:w-48 lg:rounded-t-none lg:rounded-l" styles="background-image: url('/mountain.jpg')" >
                            </div>
                            <div className="flex flex-col justify-between p-4 leading-normal bg-white border-gray-400 rounded-b  lg:border-l-0 lg:border-t lg:border-gray-400 lg:rounded-b-none lg:rounded-r">
                                <div className="mb-8">
                                    ...
                                    <div className="mb-2 text-xl font-bold text-gray-900">{item.problem}  </div>
                                    <p className="text-base text-gray-700">{item.description} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.</p>
                                </div>
