              ...
              <div className="flex w-full mb-16 lg:w-1/2 lg:mb-0">
                <div className="w-full px-6 lg:w-1/2">
                  <ul>
                    <li>
                      <Link href="#">
                        <h2 className="text-l leading-none lg:text-l hover:text-brand text-white-800 text-white-50">
                          About Our Website{" "}
                        </h2>
                      </Link>
                    </li>
                ...
                <div className="w-full px-6 lg:w-1/2">
                  <ul>
                    ...
                    <li className="mt-6">
                      <Link href="#">
                        <a className="text-xs leading-none lg:text-sm hover:text-brand text-white-800 text-white-50"></a>
                      </Link>
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex w-full lg:w-1/2">
                <div className="w-full px-6 lg:w-1/2">
                  <ul>
                    ...
                    <li className="mt-6">
                      <Link href="#">
                        <a className="text-xl leading-none lg:text-sm hover:text-brand text-white-800 text-white-50"></a>
                      </Link>
                    </li>
